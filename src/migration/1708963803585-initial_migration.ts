...
export class initialMigration1708963803585 implements MigrationInterface {
  name = 'initialMigration1708963803585'

  public async up (queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query('CREATE TABLE "trade" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "baseAmount" numeric(45,32) NOT NULL, "quoteAmount" numeric(45,32) NOT NULL, "rate" numeric(45,32) NOT NULL, "date" TIMESTAMP NOT NULL, "baseTickerId" uuid, "quoteTickerId" uuid, CONSTRAINT "PK_d4097908741dc408f8274ebdc53" PRIMARY KEY ("id"))')
